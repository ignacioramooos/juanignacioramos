...
export const es: Translations = {
  ...
  about: {
    ...
    p2: "Mi experiencia abarca la gestión fiduciaria de más de 1.380.000 UYU (~$35.000 USD), ocho eventos organizados, modelado técnico con Excel y simulaciones 6-DOF, desarrollo web, Cor Ad Cor y liderazgo internacional como Secretario General de Model UN. Hablo cuatro idiomas con fluidez y me guío por el principio \"Mens et Manus\", aplicando mente y mano para resolver desafíos complejos. (Más sobre mi experiencia debajo).",
    p3: "Mi trabajo actual se centra en fortalecer la base cuantitativa e ingenieril detrás de mi objetivo: promover una industria aeroespacial en Uruguay y diseñar vehículos espaciales.",
  ...
  drives: { label: "Propósito", title: "Lo que me Impulsa", items: [
    ...
    { title: "Construir espacios digitales humanos", desc: "Cor Ad Cor, reflexión privada y escucha real antes que aparentar estar bien." },
  ...
  proBono: { label: "Pro Bono", title: "Ingeniería para el Impacto", p1: "Ofrezco mis servicios profesionales de forma gratuita a organizaciones sin fines de lucro que generan cambio medible. No se trata de buena voluntad — se trata de aplicar habilidades reales donde generan mayor impacto.", p2: "Si tu organización opera en alguna de las áreas a continuación y necesita diseño web, mapeo con drones, prototipado 3D o automatización, quiero escucharte.", areas: ["Educación y Acceso", "Sostenibilidad Ambiental", "Innovación y Tecnología", "Desarrollo Comunitario"], cta: "Las organizaciones sin fines de lucro pueden solicitar servicios a través del proceso estándar de solicitud de proyectos.", ctaLink: "Explorar Servicios" },
