        ...
        <div className="max-w-4xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 gap-3">
                {[
                  ...
                  <div key={f} className="flex items-center gap-2 text-sm text-muted-foreground">
                    <CheckCircle2 size={14} className="text-foreground/60 flex-shrink-0" />
                    {f}
                  </div>
                ))}
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            <motion.div
              ...
              className="p-5 rounded-2xl bg-card border border-border"
            >
              <Lightbulb size={18} className="text-muted-foreground mb-3" />
              ...
              <ul className="space-y-2">
                {service.deliverables.map((d) => (
                  <li key={d} className="text-sm text-muted-foreground flex items-start gap-2">
                    <CheckCircle2 size={12} className="text-foreground/50 mt-0.5 flex-shrink-0" />
                    {d}
                  </li>
                ))}
              </ul>
