      ...
      <div className="pt-24 pb-16 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h1 className="font-display text-4xl sm:text-5xl font-bold mb-4">Services</h1>
            <p className="text-muted-foreground max-w-2xl mb-12">
              From web design to drone videography, 3D printing to AI automation — I offer professional services grounded in engineering rigor and creative problem-solving.
            </p>
          </motion.div>
